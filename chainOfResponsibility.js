/**
 * by Ruslan Malogulko => https://github.com/ruslanmalogulko
...
const coffeeMachine = new CoffeeMachine(coffeeHandlers, [
  "sugar",
  "milk",
  "cinnamon",
]);
...
coffeeMachine.setNewIngredients(["cinnamon","milk"]).processCoffee();
